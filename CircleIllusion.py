...
turtle.tracer(1000, 0)  #sets the turtle to draw almost instantaneously. At (0,0) crashes on my PC :( Not sure what's up with that. Will update with more info
...
def draw():
    ...
    if not hasDrawn:
        ...
        pattern = [primroseColour1, primroseColour2, primroseColour2, primroseColour1, primroseColour2, primroseColour1, primroseColour1, primroseColour2]
